...
@interface SmallImageShowViewController ()
...
@implementation SmallImageShowViewController
...
- (void)viewDidLoad
{
    ...
    _contentView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, imageView.frame.size.width, imageView.frame.size.height)];
...
//    [_contentView addSubview:button];
    ...
    _myScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 100, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-100)];
